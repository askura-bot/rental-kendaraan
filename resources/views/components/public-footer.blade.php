        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex gap-3">
                    <a href="#" class="w-9 h-9 bg-primary-800 hover:bg-primary-700 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-sm text-gray-400">Jl. Raya Utama No. 123,<br>Jakarta, Indonesia</span>
                    </li>
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <span class="text-sm text-gray-400">info@driveease.com</span>
                    </li>
                </ul>
            </div>
        </div>
