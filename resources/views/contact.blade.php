            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-primary-100 rounded-2xl p-5 sm:p-7 border border-primary-200 shadow-sm">
                        ...
                        <p class="text-sm text-gray-600">{!! nl2br(e($contactSettings['office_address'])) !!}</p>
                    </div>
                    ...
                    <div class="bg-primary-100 rounded-2xl p-5 sm:p-7 border border-primary-200 shadow-sm">
                        ...
                        <h3 class="font-bold text-gray-900 mb-1">{{ __('WhatsApp') }}</h3>
                        <p class="text-sm text-gray-600">{{ $contactSettings['whatsapp'] }}</p>
                    </div>
                    ...
                    <div class="bg-primary-100 rounded-2xl p-5 sm:p-7 border border-primary-200 shadow-sm">
                        ...
                        <p class="text-sm text-gray-600">{{ $contactSettings['email'] }}</p>
                    </div>
                    ...
                    <div class="bg-primary-100 rounded-2xl p-5 sm:p-7 border border-primary-200 shadow-sm">
                        ...
                        <p class="text-sm text-gray-600">{{ $contactSettings['hours_weekday'] }}</p>
                        <p class="text-sm text-gray-600">{{ $contactSettings['hours_weekend'] }}</p>
                    </div>
                </div>
